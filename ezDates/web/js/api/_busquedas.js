...
const busquedasAPI_auto = {
    ...
    getById: async function(busquedaId) {
        let response = await axios.get(`${BASE_URL}/busquedas/${busquedaId}`, requestOptions);
    ...
    update: async function(formData, busquedaId) {
        let response = await axios.put(`${BASE_URL}/busquedas/${busquedaId}`, formData, requestOptions);
        return response.data;
    },

    /** Deletes an existing entry in 'busquedas' by its primary key */
    delete: async function(busquedaId) {
        let response = await axios.delete(`${BASE_URL}/busquedas/${busquedaId}`, requestOptions);
        return response.data;
    },
};
